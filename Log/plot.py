...
plot_ind = range(7,10)
a_pre=np.loadtxt('/home/amr1/ws/src/PI_amr_v2_navigation/FAST_LIO/Log/mat_pre.txt')
a_out=np.loadtxt('/home/amr1/ws/src/PI_amr_v2_navigation/FAST_LIO/Log/mat_out.txt')
time=a_pre[:,0]
